...
let songList=[
  {"name":"李文约","type":"netease","id":"8145557762"},
  {"name":"陈妍妍","type":"tencent","id":"378883306"},
  {"name":"周俊熙","type":"tencent","id":"2211143208"}
]

let server = "tencent"; //netease: 网易云音乐; tencent: QQ音乐; kugou: 酷狗音乐; xiami: 虾米; kuwo: 酷我
let type = "playlist"; //song: 单曲; playlist: 歌单; album: 唱片
let id = "2211143208"; //封面 ID / 单曲 ID / 歌单 ID

// test:https://api.wuenci.com/meting/api/?server=tencent&type=playlist&id=2211143208
$.ajax({
    ...
    error: function (xhr, status, error) {
        ...
        // 这里你可以抛出一个自定义错误，或者采取其他适当的措施
        throw new Error("Ajax request failed: " + status + ", " + error);
