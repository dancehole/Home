...
| ------------------------------- | ---------------------------- |
| ☑️日期及时间                     |                              |
| ☑️载入动画+hello pin（开屏问候） | ◻️新增通讯录生日问候(todo)    |
| ☑️站点简介                       | ✅                            |
| ☑️Hitokoto 一言                  | ✏️新增个人语录摘取            |
| ☑️实时天气                       | ❌原位置修改为特殊日子通知    |
| ☑️时光进度条                     | ◻️✏️新增当前任务完成情况(todo) |
| ☑️音乐播放器                     | ❌删除(可酌情新增Aplayer)     |
| ☑️移动端适配                     |                              |
| ◻️去除 jQuery 依赖               |                              |
| ◻️VUE 重构                       |                              |
|                                 |                              |
...
- **一言截断**：标题与正文各自最多 60 字，且标题+正文总长度不超过 80 字（超出时优先截断正文），详情弹窗（右击）仍展示完整内容
